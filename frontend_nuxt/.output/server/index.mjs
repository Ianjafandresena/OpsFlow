...
import { G as toNodeListener, h as destr, J as useRuntimeConfig, H as trapUnhandledNodeErrors, F as setupGracefulShutdown, I as useNitroApp } from './chunks/_/nitro.mjs';
import 'node:events';
import 'node:buffer';
import 'node:fs';
import 'node:path';
