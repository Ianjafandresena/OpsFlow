import { _ as __nuxt_component_0$1 } from './nuxt-link-D05iz29k.mjs';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.role === "admin") {
        ...
        _push(`</div><div data-v-c367499b><div class="nav-section-title" data-v-c367499b>T\xE2ches par D\xE9partement</div>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/admin/taches/cm",
          class: "nav-link",
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(` Monteurs Vid\xE9o `);
            } else {
              return [
                createVNode(unref(Film), { size: 15 }),
                createTextVNode(" Monteurs Vid\xE9o ")
              ];
            }
          }),
          _: 1
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(` D\xE9veloppeurs Web `);
            } else {
              return [
                createVNode(unref(Code), { size: 15 }),
                createTextVNode(" D\xE9veloppeurs Web ")
              ];
            }
          }),
          _: 1
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(` \xC9quipe &amp; R\xF4les `);
            } else {
              return [
                createVNode(unref(Users), { size: 15 }),
                createTextVNode(" \xC9quipe & R\xF4les ")
              ];
            }
          }),
          _: 1
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(` \xC9v\xE9nements &amp; Villes `);
            } else {
              return [
                createVNode(unref(Settings), { size: 15 }),
                createTextVNode(" \xC9v\xE9nements & Villes ")
              ];
            }
          }),
          _: 1
      ...
      if (__props.role === "employe") {
        ...
        _push(`</div><div data-v-c367499b><div class="nav-section-title" data-v-c367499b>Mon Activit\xE9</div>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/employe/taches",
          class: "nav-link",
          "active-class": "nav-link-active"
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(` Mes T\xE2ches `);
            } else {
              return [
                createVNode(unref(ListTodo), { size: 15 }),
                createTextVNode(" Mes T\xE2ches ")
              ];
            }
          }),
          _: 1
...
//# sourceMappingURL=Sidebar-DpkFoeuh.mjs.map
