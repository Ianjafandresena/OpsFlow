...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const designerEquipe = computed(() => {
      if (!employes.value) return [];
      return employes.value.filter((e) => {
        var _a, _b, _c, _d;
        return ((_b = (_a = e.poste) == null ? void 0 : _a.titre_poste) == null ? void 0 : _b.includes("Designer")) || ((_d = (_c = e.poste) == null ? void 0 : _c.titre_poste) == null ? void 0 : _d.includes("Graphiste"));
      });
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "animate-fade-in" }, _attrs))}><div class="page-header"><div><h1 class="page-title">T\xE2ches Designers</h1><p class="page-subtitle" style="${ssrRenderStyle({ "margin-bottom": "0" })}">Suivi des cr\xE9ations graphiques (affiches, caroussels IG).</p></div><button class="btn btn-primary">`);
      _push(ssrRenderComponent(unref(Plus), { size: 15 }, null, _parent));
      _push(` Nouveau Livrable </button></div><div class="card toolbar" style="${ssrRenderStyle({ "margin-bottom": "1.25rem" })}"><div class="search-wrapper">`);
      _push(ssrRenderComponent(unref(Search), {
        class: "search-icon",
        size: 14
      }, null, _parent));
      _push(`<input type="text"${ssrRenderAttr("value", filters.value.search)} placeholder="Rechercher un visuel..." class="form-input"></div><select class="form-input"><option value=""${ssrIncludeBooleanAttr(Array.isArray(filters.value.editionId) ? ssrLooseContain(filters.value.editionId, "") : ssrLooseEqual(filters.value.editionId, "")) ? " selected" : ""}>Toutes les Pages</option><!--[-->`);
      ...
      _push(`<!--]--></select><select class="form-input"><option value=""${ssrIncludeBooleanAttr(Array.isArray(filters.value.employeId) ? ssrLooseContain(filters.value.employeId, "") : ssrLooseEqual(filters.value.employeId, "")) ? " selected" : ""}>Tous les Designers</option><!--[-->`);
      ssrRenderList(designerEquipe.value, (emp) => {
      ...
      _push(`<!--]--></select></div><div class="card" style="${ssrRenderStyle({ "padding": "0", "overflow": "hidden" })}"><table class="data-table"><thead><tr><th>Nom du Livrable</th><th>\xC9v\xE9nement</th><th>Type</th><th>Quantit\xE9</th><th>Designer Assign\xE9</th><th>Deadline</th><th>Statut</th><th style="${ssrRenderStyle({ "text-align": "right" })}">Actions</th></tr></thead><tbody><!--[-->`);
      ssrRenderList(filteredTasks.value, (task) => {
        var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j;
        _push(`<tr><td style="${ssrRenderStyle({ "font-weight": "600" })}">${ssrInterpolate(task.titre)}</td><td style="${ssrRenderStyle({ "color": "var(--text-secondary)" })}">${ssrInterpolate((_b = (_a = task.edition) == null ? void 0 : _a.licence) == null ? void 0 : _b.sigle)} - ${ssrInterpolate((_d = (_c = task.edition) == null ? void 0 : _c.ville) == null ? void 0 : _d.nom_ville)}</td><td><span class="badge badge-neutral">${ssrInterpolate(task.type_visuel)}</span></td><td>${ssrInterpolate(task.quantite || 1)}</td><td style="${ssrRenderStyle({ "font-weight": "500" })}">${ssrInterpolate((_e = task.employe) == null ? void 0 : _e.prenom)} ${ssrInterpolate((_f = task.employe) == null ? void 0 : _f.nom[0])}.</td><td style="${ssrRenderStyle({ "color": "var(--text-secondary)" })}">${ssrInterpolate(new Date(task.date_limite).toLocaleDateString())}</td><td><span class="badge" style="${ssrRenderStyle({ background: ((_g = task.statutTache) == null ? void 0 : _g.couleur) + "20", color: (_h = task.statutTache) == null ? void 0 : _h.couleur, border: "1px solid " + ((_i = task.statutTache) == null ? void 0 : _i.couleur) })}">${ssrInterpolate((_j = task.statutTache) == null ? void 0 : _j.nom)}</span></td><td style="${ssrRenderStyle({ "text-align": "right" })}"><div class="actions-cell"><button class="btn btn-secondary btn-icon" title="Voir d\xE9tails">`);
      ...
      if (filteredTasks.value.length === 0) {
        _push(`<tr><td colspan="8" style="${ssrRenderStyle({ "text-align": "center", "padding": "2rem", "color": "var(--text-secondary)" })}">Aucun livrable trouv\xE9.</td></tr>`);
      } else {
        _push(`<!---->`);
      }
          ...
          if (_push2) {
            ...
            return [
              createVNode("form", {
                ...
                createVNode("div", { class: "form-group" }, [
                  createVNode("label", { class: "form-label" }, "Attribuer \xE0 (Designer)"),
                  withDirectives(createVNode("select", {
                    ...
                    (openBlock(true), createBlock(Fragment, null, renderList(designerEquipe.value, (emp) => {
                ...
                createVNode("div", { class: "form-group" }, [
                  createVNode("label", { class: "form-label" }, "Brief & Instructions"),
                  withDirectives(createVNode("textarea", {
                    "onUpdate:modelValue": ($event) => form.value.description = $event,
                    class: "form-input",
                    rows: "3",
                    placeholder: "Dimensions, couleurs, ressources existantes..."
                  }, null, 8, ["onUpdate:modelValue"]), [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/taches/designer.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=designer-OpBbe5_k.mjs.map
