...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const userDept = computed(() => {
      var _a, _b, _c, _d, _e;
      const p = ((_b = (_a = myEmployeInfo.value) == null ? void 0 : _a.poste) == null ? void 0 : _b.titre_poste) || "";
      if (p.includes("Monteur")) return "Audiovisuel";
      if (p.includes("Designer") || p.includes("Graphiste")) return "Design";
      if (p.includes("D\xE9veloppeur") || p.includes("Tech")) return "Technique";
      return ((_e = (_d = (_c = myEmployeInfo.value) == null ? void 0 : _c.poste) == null ? void 0 : _d.departement) == null ? void 0 : _e.nom_departement) || "Communication";
    });
    ...
    const save = async () => {
      if (isDemandeModif.value) {
        ...
        motifModal.value = {
          ...
          message: `Veuillez sp\xE9cifier le motif pour la modification de la t\xE2che : "${form.value.titre}".`,
          motif: "",
          type: "MODIFICATION",
      ...
      if (userDept.value === "Communication") {
        if (editing.value || form.value.typeTache !== "Sponsorisation (Ads)") {
          ...
          if (body.typeTache === "D\xE9marche Administrative") genTitre = body.type_demarche || "D\xE9marche";
      ...
      if (motifModal.value.type === "MODIFICATION" && motifModal.value.payload) {
        ...
        if (userDept.value === "Communication") {
          ...
          if (payload.typeTache === "Publication") {
            payload.plateforme = ((_a = payload.plateformes) == null ? void 0 : _a.join(", ")) || "";
          ...
          } else if (payload.typeTache === "D\xE9marche Administrative") {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (myEmployeInfo.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "animate-fade-in" }, _attrs))}><div class="page-header"><div><h1 class="page-title">Mes T\xE2ches</h1><p class="page-subtitle" style="${ssrRenderStyle({ "margin-bottom": "0" })}">Suivi de vos assignations pour ${ssrInterpolate((_a = myEmployeInfo.value.poste) == null ? void 0 : _a.titre_poste)}</p></div><button class="btn btn-primary">`);
        ...
        _push(`<input type="text"${ssrRenderAttr("value", filters.value.search)} placeholder="Rechercher une t\xE2che..." class="form-input"></div>`);
        if (userDept.value !== "Audiovisuel") {
          ...
          ssrRenderList(unref(editions), (ed) => {
            var _a2, _b;
            _push(`<option${ssrRenderAttr("value", ed.id)}${ssrIncludeBooleanAttr(Array.isArray(filters.value.editionId) ? ssrLooseContain(filters.value.editionId, ed.id) : ssrLooseEqual(filters.value.editionId, ed.id)) ? " selected" : ""}>${ssrInterpolate((_a2 = ed.licence) == null ? void 0 : _a2.sigle)} - ${ssrInterpolate((_b = ed.ville) == null ? void 0 : _b.nom_ville)}</option>`);
          });
          _push(`<!--]--></select>`);
        } else {
          _push(`<!---->`);
        ...
        _push(`<!--]--></select></div><div class="card" style="${ssrRenderStyle({ "padding": "0", "overflow": "visible" })}"><table class="data-table"><thead><tr><th>T\xE2che</th>`);
        if (userDept.value !== "Audiovisuel") {
          _push(`<th>Projet / \xC9v\xE9nement</th>`);
        } else {
          _push(`<!---->`);
        }
        ...
        ssrRenderList(filteredTasks.value, (task) => {
          ...
          if (userDept.value !== "Audiovisuel") {
            _push(`<td style="${ssrRenderStyle({ "color": "var(--text-secondary)" })}">${ssrInterpolate((_b = (_a2 = task.edition) == null ? void 0 : _a2.licence) == null ? void 0 : _b.sigle)} - ${ssrInterpolate((_d = (_c = task.edition) == null ? void 0 : _c.ville) == null ? void 0 : _d.nom_ville)}</td>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<td style="${ssrRenderStyle({ "color": "var(--text-secondary)" })}"><strong style="${ssrRenderStyle({ color: new Date(task.date_limite) < /* @__PURE__ */ new Date() && ((_e = task.statutTache) == null ? void 0 : _e.nom) !== "Termin\xE9" && ((_f = task.statutTache) == null ? void 0 : _f.nom) !== "Publi\xE9" ? "var(--danger-color)" : "inherit" })}">${ssrInterpolate(new Date(task.date_limite).toLocaleDateString())}</strong></td><td><select class="form-input" style="${ssrRenderStyle([{ "padding": "0.25rem 0.5rem", "font-size": "0.75rem", "border-radius": "4px" }, { background: ((_g = task.statutTache) == null ? void 0 : _g.couleur) + "20", color: (_h = task.statutTache) == null ? void 0 : _h.couleur, borderColor: (_i = task.statutTache) == null ? void 0 : _i.couleur }])}"><!--[-->`);
          ssrRenderList(unref(statuts), (st) => {
          ...
          if (activeDropdownId.value === task.id) {
            ...
            _push(` Voir les d\xE9tails </button><button type="button" class="dropdown-item">`);
            _push(ssrRenderComponent(unref(Check), { size: 13 }, null, _parent));
            _push(` Terminer la t\xE2che </button><button type="button" class="dropdown-item">`);
        ...
        if (filteredTasks.value.length === 0) {
          _push(`<tr><td${ssrRenderAttr("colspan", userDept.value === "Audiovisuel" ? 4 : 5)} style="${ssrRenderStyle({ "text-align": "center", "padding": "2rem", "color": "var(--text-secondary)" })}">Aucune t\xE2che trouv\xE9e.</td></tr>`);
        } else {
          _push(`<!---->`);
        }
        ...
        _push(ssrRenderComponent(_component_Modal, {
          isOpen: modal.value,
          title: isDemandeModif.value ? "Demande de Modification" : editing.value ? "Modifier la T\xE2che" : "Nouvelle T\xE2che",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (userDept.value === "Communication") {
                ...
                ssrRenderList(unref(editions), (ed) => {
                  var _a2, _b;
                  _push2(`<option${ssrRenderAttr("value", ed.id)}${ssrIncludeBooleanAttr(Array.isArray(form.value.editionId) ? ssrLooseContain(form.value.editionId, ed.id) : ssrLooseEqual(form.value.editionId, ed.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate((_a2 = ed.licence) == null ? void 0 : _a2.sigle)} - ${ssrInterpolate((_b = ed.ville) == null ? void 0 : _b.nom_ville)}</option>`);
                });
                ...
                if (form.value.typeTache === "Sponsorisation (Ads)") {
                  ...
                  if (!editing.value) {
                    ...
                    ssrRenderList(form.value.sponsorisations, (sp, idx) => {
                      ...
                      if (idx === 0) {
                        _push2(`<label class="form-label"${_scopeId}>Th\xE8me \xE0 sponsoriser</label>`);
                      } else {
                        _push2(`<!---->`);
                      }
                    ...
                    _push2(`<div style="${ssrRenderStyle({ "margin-bottom": "1rem", "display": "grid", "grid-template-columns": "1fr 1fr", "gap": "1rem" })}"${_scopeId}><div class="form-group"${_scopeId}><label class="form-label"${_scopeId}>Th\xE8me \xE0 sponsoriser</label><select class="form-input" required${_scopeId}><!--[-->`);
                    ssrRenderList(unref(themes), (th) => {
              ...
              _push2(`<div class="form-group"${_scopeId}><label class="form-label"${_scopeId}>Description / D\xE9tails / Brief</label><textarea class="form-input" rows="3" placeholder="Informations compl\xE9mentaires, liens, consignes..."${_scopeId}>${ssrInterpolate(form.value.description)}</textarea></div><div style="${ssrRenderStyle({ "display": "flex", "justify-content": "flex-end", "gap": "0.5rem", "margin-top": "0.5rem" })}"${_scopeId}><button type="button" class="btn btn-secondary"${_scopeId}>Annuler</button><button type="submit" class="btn btn-primary"${_scopeId}>${ssrInterpolate(isDemandeModif.value ? "Envoyer la Demande" : editing.value ? "Enregistrer" : "Cr\xE9er")}</button></div></form>`);
            } else {
              return [
                createVNode("form", {
                  ...
                  userDept.value === "Communication" ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                        ...
                        withDirectives(createVNode("select", {
                          ...
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(editions), (ed) => {
                            ...
                            return openBlock(), createBlock("option", {
                              key: ed.id,
                              value: ed.id
                            }, toDisplayString((_a2 = ed.licence) == null ? void 0 : _a2.sigle) + " - " + toDisplayString((_b = ed.ville) == null ? void 0 : _b.nom_ville), 9, ["value"]);
                          }), 128))
                        ], 8, ["onUpdate:modelValue"]), [
                    ...
                    form.value.typeTache === "D\xE9marche Administrative" ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { style: { "display": "grid", "grid-template-columns": "1fr 1fr", "gap": "1rem" } }, [
                        ...
                        createVNode("div", { class: "form-group" }, [
                          createVNode("label", { class: "form-label" }, "Date limite R\xE9sultat"),
                          withDirectives(createVNode("input", {
                            type: "date",
                            "onUpdate:modelValue": ($event) => form.value.date_limite = $event,
                            class: "form-input",
                    ...
                    form.value.typeTache === "Sponsorisation (Ads)" ? (openBlock(), createBlock("div", {
                      ...
                      !editing.value ? (openBlock(), createBlock("div", {
                          ...
                          return openBlock(), createBlock("div", {
                            ...
                            createVNode("div", { class: "form-group" }, [
                              idx === 0 ? (openBlock(), createBlock("label", {
                                key: 0,
                                class: "form-label"
                              }, "Th\xE8me \xE0 sponsoriser")) : createCommentVNode("", true),
                              withDirectives(createVNode("select", {
                        ...
                        createVNode("div", { class: "form-group" }, [
                          createVNode("label", { class: "form-label" }, "Th\xE8me \xE0 sponsoriser"),
                          withDirectives(createVNode("select", {
                    ...
                    createVNode("div", { class: "form-group" }, [
                      ...
                      withDirectives(createVNode("input", {
                        ...
                        required: "",
                        class: "form-input",
                        placeholder: "Ex: Affiche A3, Visuel Annonce Invit\xE9..."
                      }, null, 8, ["onUpdate:modelValue"]), [
                        [vModelText, form.value.titre]
                      ])
                    ]),
                    createVNode("div", { class: "form-group" }, [
                      createVNode("label", { class: "form-label" }, "\xC9v\xE9nement"),
                      withDirectives(createVNode("select", {
                        "onUpdate:modelValue": ($event) => form.value.editionId = $event,
                        required: "",
                        class: "form-input"
                    ...
                    createVNode("div", { style: { "display": "grid", "grid-template-columns": "1fr 1fr", "gap": "1rem" } }, [
                      ...
                      createVNode("div", { class: "form-group" }, [
                        createVNode("label", { class: "form-label" }, "Quantit\xE9 (D\xE9clinaisons)"),
                        withDirectives(createVNode("input", {
                          type: "number",
                  ...
                  createVNode("div", { class: "form-group" }, [
                    createVNode("label", { class: "form-label" }, "Description / D\xE9tails / Brief"),
                    withDirectives(createVNode("textarea", {
                      "onUpdate:modelValue": ($event) => form.value.description = $event,
                      class: "form-input",
                      rows: "3",
                      placeholder: "Informations compl\xE9mentaires, liens, consignes..."
                    }, null, 8, ["onUpdate:modelValue"]), [
                  ...
                  createVNode("div", { style: { "display": "flex", "justify-content": "flex-end", "gap": "0.5rem", "margin-top": "0.5rem" } }, [
                    ...
                    }, toDisplayString(isDemandeModif.value ? "Envoyer la Demande" : editing.value ? "Enregistrer" : "Cr\xE9er"), 1)
                  ])
                ], 32)
              ];
            }
...
//# sourceMappingURL=index-BPqmj_BC.mjs.map
