...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><section><div class="page-header"><div><h1 class="page-title">Éditions Planifiées (Projets/Pages)</h1><p class="page-subtitle" style="${ssrRenderStyle({ "margin-bottom": "0" })}">Planifiez une édition en associant une Licence et une Ville.</p></div><button class="btn btn-primary">`);
      _push(ssrRenderComponent(unref(Plus), { size: 15 }, null, _parent));
      _push(` Planifier une édition </button></div><div class="card" style="${ssrRenderStyle({ "padding": "0", "overflow": "hidden" })}"><table class="data-table"><thead><tr><th>Type d&#39;événement</th><th>Ville / Page concernée</th><th>Dates</th><th style="${ssrRenderStyle({ "text-align": "right" })}">Actions</th></tr></thead><tbody><!--[-->`);
      ...
      if (unref(editions).length === 0) {
        _push(`<tr><td colspan="4" style="${ssrRenderStyle({ "text-align": "center", "padding": "2rem", "color": "var(--text-secondary)" })}">Aucun événement planifié.</td></tr>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</tbody></table></div></section><div style="${ssrRenderStyle({ "display": "grid", "grid-template-columns": "1fr 1fr", "gap": "2rem" })}"><section><div class="page-header" style="${ssrRenderStyle({ "margin-bottom": "1rem" })}"><div><h2 class="page-title" style="${ssrRenderStyle({ "font-size": "1.1rem" })}">Types d&#39;Événements</h2><p class="page-subtitle" style="${ssrRenderStyle({ "margin-bottom": "0", "font-size": "0.8rem" })}">Gérez les licences (ex: JOF, JMW).</p></div><button class="btn btn-secondary" style="${ssrRenderStyle({ "font-size": "0.8rem", "padding": "0.3rem 0.6rem" })}">`);
      ...
      _push(`<!--]--></tbody></table></div></section><section><div class="page-header" style="${ssrRenderStyle({ "margin-bottom": "1rem" })}"><div><h2 class="page-title" style="${ssrRenderStyle({ "font-size": "1.1rem" })}">Villes</h2><p class="page-subtitle" style="${ssrRenderStyle({ "margin-bottom": "0", "font-size": "0.8rem" })}">Gérez la liste des villes.</p></div><button class="btn btn-secondary" style="${ssrRenderStyle({ "font-size": "0.8rem", "padding": "0.3rem 0.6rem" })}">`);
      _push(ssrRenderComponent(unref(Plus), { size: 14 }, null, _parent));
      ...
      _push(`<!--]--></tbody></table></div></section></div><section><div class="page-header"><div><h2 class="page-title">Thèmes de Publication</h2><p class="page-subtitle" style="${ssrRenderStyle({ "margin-bottom": "0" })}">Gérez les sujets par défaut pour les posts et les sponsorisations.</p></div><button class="btn btn-primary">`);
      _push(ssrRenderComponent(unref(Plus), { size: 15 }, null, _parent));
      _push(` Ajouter un Thème </button></div><div class="card" style="${ssrRenderStyle({ "padding": "0", "overflow": "hidden", "max-width": "600px" })}"><table class="data-table"><thead><tr><th>Nom du Thème (Sujet)</th><th style="${ssrRenderStyle({ "text-align": "right" })}">Actions</th></tr></thead><tbody><!--[-->`);
      ...
      if (unref(themes).length === 0) {
        _push(`<tr><td colspan="2" style="${ssrRenderStyle({ "text-align": "center", "padding": "2rem", "color": "var(--text-secondary)" })}">Aucun thème configuré.</td></tr>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(ssrRenderComponent(_component_Modal, {
        isOpen: modal.value,
        title: editing.value ? "Modifier l'édition" : "Planifier une édition",
        onClose: ($event) => modal.value = false
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "gap": "1rem" })}"${_scopeId}><div class="form-group"${_scopeId}><label class="form-label"${_scopeId}>Type d&#39;événement</label><select required class="form-input"${_scopeId}><!--[-->`);
            ssrRenderList(unref(typesEv), (t) => {
            ...
            return [
              createVNode("form", {
                ...
                createVNode("div", { class: "form-group" }, [
                  createVNode("label", { class: "form-label" }, "Type d'événement"),
                ...
                createVNode("div", { style: { "display": "grid", "grid-template-columns": "1fr 1fr", "gap": "1rem" } }, [
                  createVNode("div", { class: "form-group" }, [
                    createVNode("label", { class: "form-label" }, "Date de début"),
                ...
                createVNode("div", {
                  ...
                  createVNode("label", { style: { "font-size": "0.75rem", "color": "var(--text-secondary)" } }, "Nom de la Page généré :"),
                ...
                createVNode("div", { class: "form-group" }, [
                  ...
                  createVNode("div", { style: { "font-size": "0.7rem", "color": "var(--text-muted)", "margin-top": "0.25rem" } }, "Permet à l'agent IA de récupérer les statistiques de cette page.")
                ]),
      ...
      _push(ssrRenderComponent(_component_Modal, {
        ...
        title: editingTheme.value ? "Modifier le Thème" : "Nouveau Thème",
        onClose: ($event) => modalTheme.value = false
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "gap": "1rem" })}"${_scopeId}><div class="form-group"${_scopeId}><label class="form-label"${_scopeId}>Nom du Thème</label><input type="text"${ssrRenderAttr("value", formTheme.value.nom_theme)} required class="form-input" placeholder="Ex: Pass VIP, Annonce, Concours..."${_scopeId}></div><div style="${ssrRenderStyle({ "display": "flex", "justify-content": "flex-end", "gap": "0.5rem", "margin-top": "1rem" })}"${_scopeId}><button type="button" class="btn btn-secondary"${_scopeId}>Annuler</button><button type="submit" class="btn btn-primary"${_scopeId}>${ssrInterpolate(editingTheme.value ? "Enregistrer" : "Créer")}</button></div></form>`);
          } else {
            return [
              createVNode("form", {
                ...
                createVNode("div", { class: "form-group" }, [
                  createVNode("label", { class: "form-label" }, "Nom du Thème"),
                  withDirectives(createVNode("input", {
                    type: "text",
                ...
                createVNode("div", { style: { "display": "flex", "justify-content": "flex-end", "gap": "0.5rem", "margin-top": "1rem" } }, [
                  ...
                  createVNode("button", {
                    type: "submit",
                    class: "btn btn-primary"
                  }, toDisplayString(editingTheme.value ? "Enregistrer" : "Créer"), 1)
                ])
              ], 32)
            ];
          }
...
//# sourceMappingURL=index-Jm1KRM4s.js.map
