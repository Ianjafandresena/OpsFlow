...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "animate-fade-in" }, _attrs))}><div class="page-header"><div><h1 class="page-title">Tâches CM &amp; Administratives</h1><p class="page-subtitle" style="${ssrRenderStyle({ "margin-bottom": "0" })}">Planification des publications et suivi des dossiers (sécurité, ARS, boissons...).</p></div><button class="btn btn-primary">`);
      ...
      _push(`<input type="text"${ssrRenderAttr("value", filters.value.search)} placeholder="Rechercher..." class="form-input"></div><select class="form-input"><option value=""${ssrIncludeBooleanAttr(Array.isArray(filters.value.typeTache) ? ssrLooseContain(filters.value.typeTache, "") : ssrLooseEqual(filters.value.typeTache, "")) ? " selected" : ""}>Tous les Types</option><option${ssrIncludeBooleanAttr(Array.isArray(filters.value.typeTache) ? ssrLooseContain(filters.value.typeTache, null) : ssrLooseEqual(filters.value.typeTache, null)) ? " selected" : ""}>Publication</option><option${ssrIncludeBooleanAttr(Array.isArray(filters.value.typeTache) ? ssrLooseContain(filters.value.typeTache, null) : ssrLooseEqual(filters.value.typeTache, null)) ? " selected" : ""}>Démarche Administrative</option><option${ssrIncludeBooleanAttr(Array.isArray(filters.value.typeTache) ? ssrLooseContain(filters.value.typeTache, null) : ssrLooseEqual(filters.value.typeTache, null)) ? " selected" : ""}>Mailing (Newsletter)</option><option${ssrIncludeBooleanAttr(Array.isArray(filters.value.typeTache) ? ssrLooseContain(filters.value.typeTache, null) : ssrLooseEqual(filters.value.typeTache, null)) ? " selected" : ""}>Sponsorisation (Ads)</option></select><select class="form-input"><option value=""${ssrIncludeBooleanAttr(Array.isArray(filters.value.editionId) ? ssrLooseContain(filters.value.editionId, "") : ssrLooseEqual(filters.value.editionId, "")) ? " selected" : ""}>Toutes les Pages</option><!--[-->`);
      ...
      _push(`<!--]--></select><select class="form-input"><option value=""${ssrIncludeBooleanAttr(Array.isArray(filters.value.employeId) ? ssrLooseContain(filters.value.employeId, "") : ssrLooseEqual(filters.value.employeId, "")) ? " selected" : ""}>Toute l&#39;équipe</option><!--[-->`);
      ...
      _push(`<!--]--></select></div><div class="card" style="${ssrRenderStyle({ "padding": "0", "overflow": "hidden" })}"><table class="data-table"><thead><tr><th>Page Concernée</th><th>Type</th><th>Sujet / Démarche</th><th>Assigné à</th><th>Dates / Échéance</th><th>Statut</th><th style="${ssrRenderStyle({ "text-align": "right" })}">Actions</th></tr></thead><tbody><!--[-->`);
      ssrRenderList(filteredTasks.value, (t) => {
        _push(`<tr><td style="${ssrRenderStyle({ "font-weight": "600" })}">${ssrInterpolate(t.edition?.licence?.sigle)} - ${ssrInterpolate(t.edition?.ville?.nom_ville)}</td><td><span class="${ssrRenderClass([t.type_pub ? "badge-primary" : t.type_demarche ? "badge-neutral" : t.budget || t.titre.includes("Sponsorisation") ? "badge-warning" : "badge-info", "badge"])}">`);
        if (t.type_demarche) {
          _push(`<!--[-->Démarche Administrative<!--]-->`);
        ...
        _push(`</span></td><td><div style="${ssrRenderStyle({ "font-weight": "600", "font-size": "0.875rem" })}">${ssrInterpolate(t.titre)}</div><div style="${ssrRenderStyle({ "color": "var(--text-secondary)", "font-size": "0.75rem", "margin-top": "2px", "max-width": "250px", "white-space": "nowrap", "overflow": "hidden", "text-overflow": "ellipsis" })}">${ssrInterpolate(t.description)}</div></td><td style="${ssrRenderStyle({ "font-weight": "500" })}">${ssrInterpolate(t.employe?.prenom)} ${ssrInterpolate(t.employe?.nom[0])}.</td><td style="${ssrRenderStyle({ "font-size": "0.8125rem" })}">`);
        if (t.type_demarche) {
          _push(`<div> Dem : ${ssrInterpolate(t.date_demande ? new Date(t.date_demande).toLocaleDateString() : "—")}<br> Rés : <strong style="${ssrRenderStyle({ color: t.date_resultat && new Date(t.date_resultat) < /* @__PURE__ */ new Date() && t.statutTache?.nom !== "Terminé" ? "var(--danger-color)" : "inherit" })}">${ssrInterpolate(t.date_resultat ? new Date(t.date_resultat).toLocaleDateString() : "En attente")}</strong></div>`);
        } else {
          _push(`<div> Envoi : <strong style="${ssrRenderStyle({ color: new Date(t.date_limite) < /* @__PURE__ */ new Date() && t.statutTache?.nom !== "Publié" && t.statutTache?.nom !== "Terminé" ? "var(--danger-color)" : "inherit" })}">${ssrInterpolate(new Date(t.date_limite).toLocaleString([], { dateStyle: "short", timeStyle: "short" }))}</strong></div>`);
        }
        _push(`</td><td><span class="badge" style="${ssrRenderStyle({ background: t.statutTache?.couleur + "20", color: t.statutTache?.couleur, border: "1px solid " + t.statutTache?.couleur })}">${ssrInterpolate(t.statutTache?.nom)}</span></td><td style="${ssrRenderStyle({ "text-align": "right" })}"><div class="actions-cell"><button class="btn btn-secondary btn-icon" title="Voir détails">`);
      ...
      if (filteredTasks.value.length === 0) {
        _push(`<tr><td colspan="7" style="${ssrRenderStyle({ "text-align": "center", "padding": "2rem", "color": "var(--text-secondary)" })}">Aucune tâche trouvée.</td></tr>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(ssrRenderComponent(_component_Modal, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (form.value.typeTache === "Sponsorisation (Ads)") {
              ...
              if (!editing.value) {
                ...
                ssrRenderList(form.value.sponsorisations, (sp, idx) => {
                  ...
                  if (idx === 0) {
                    _push2(`<label class="form-label"${_scopeId}>Thème du post à sponsoriser</label>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`<select class="form-input" required${_scopeId}><option value="" disabled${ssrIncludeBooleanAttr(Array.isArray(sp.themeId) ? ssrLooseContain(sp.themeId, "") : ssrLooseEqual(sp.themeId, "")) ? " selected" : ""}${_scopeId}>Choisir un thème</option><!--[-->`);
                  ssrRenderList(unref(themes), (th) => {
                ...
                _push2(` Ajouter un autre thème à sponsoriser </button></div>`);
              } else {
                _push2(`<div style="${ssrRenderStyle({ "margin-bottom": "1rem", "display": "grid", "grid-template-columns": "1fr 1fr", "gap": "1rem" })}"${_scopeId}><div class="form-group"${_scopeId}><label class="form-label"${_scopeId}>Thème du post à sponsoriser</label><select class="form-input" required${_scopeId}><option value="" disabled${ssrIncludeBooleanAttr(Array.isArray(form.value.themeSponsoId) ? ssrLooseContain(form.value.themeSponsoId, "") : ssrLooseEqual(form.value.themeSponsoId, "")) ? " selected" : ""}${_scopeId}>Choisir un thème</option><!--[-->`);
                ssrRenderList(unref(themes), (th) => {
            ...
            _push2(`<div class="form-group" style="${ssrRenderStyle({ "margin-top": "0.5rem" })}"${_scopeId}><label class="form-label"${_scopeId}>Description spécifique / Détails de la tâche</label><textarea class="form-input" rows="3" placeholder="Détaillez le contenu du post ou les documents nécessaires pour la démarche..."${_scopeId}>${ssrInterpolate(form.value.description)}</textarea></div><div style="${ssrRenderStyle({ "display": "flex", "justify-content": "flex-end", "gap": "0.5rem", "margin-top": "0.5rem" })}"${_scopeId}><button type="button" class="btn btn-secondary"${_scopeId}>Annuler</button><button type="submit" class="btn btn-primary"${_scopeId}>${ssrInterpolate(editing.value ? "Enregistrer" : "Créer")}</button></div></form>`);
          } else {
            return [
              createVNode("form", {
                ...
                createVNode("div", { style: { "display": "grid", "grid-template-columns": "1fr 1fr", "gap": "1rem" } }, [
                  ...
                  createVNode("div", { class: "form-group" }, [
                    createVNode("label", { class: "form-label" }, "Assigner à"),
                    withDirectives(createVNode("select", {
                ...
                form.value.typeTache === "Démarche Administrative" ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("div", {
                    ...
                    withDirectives(createVNode("input", {
                      ...
                      class: "form-input",
                      placeholder: "Ex: Déclaration débits de boissons, Dossier Sécurité...",
                      required: ""
                    }, null, 8, ["onUpdate:modelValue"]), [
                  ...
                  createVNode("div", { style: { "display": "grid", "grid-template-columns": "1fr 1fr", "gap": "1rem" } }, [
                    ...
                    createVNode("div", { class: "form-group" }, [
                      createVNode("label", { class: "form-label" }, "Date limite de Résultat attendu"),
                      withDirectives(createVNode("input", {
                        type: "date",
                        "onUpdate:modelValue": ($event) => form.value.date_limite = $event,
                        class: "form-input",
                ...
                form.value.typeTache === "Sponsorisation (Ads)" ? (openBlock(), createBlock("div", {
                  ...
                  !editing.value ? (openBlock(), createBlock("div", {
                      ...
                      return openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "form-group" }, [
                          idx === 0 ? (openBlock(), createBlock("label", {
                            key: 0,
                            class: "form-label"
                          }, "Thème du post à sponsoriser")) : createCommentVNode("", true),
                          withDirectives(createVNode("select", {
                    ...
                    createVNode("button", {
                      ...
                      createTextVNode(" Ajouter un autre thème à sponsoriser ")
                    ], 8, ["onClick"])
                    ...
                    createVNode("div", { class: "form-group" }, [
                      createVNode("label", { class: "form-label" }, "Thème du post à sponsoriser"),
                      withDirectives(createVNode("select", {
                ...
                createVNode("div", {
                  ...
                  createVNode("label", { class: "form-label" }, "Description spécifique / Détails de la tâche"),
                  withDirectives(createVNode("textarea", {
                    "onUpdate:modelValue": ($event) => form.value.description = $event,
                    class: "form-input",
                    rows: "3",
                    placeholder: "Détaillez le contenu du post ou les documents nécessaires pour la démarche..."
                  }, null, 8, ["onUpdate:modelValue"]), [
...
//# sourceMappingURL=cm-BZzSLI0v.js.map
