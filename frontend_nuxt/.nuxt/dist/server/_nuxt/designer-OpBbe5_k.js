...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const designerEquipe = computed(() => {
      ...
      return employes.value.filter((e) => e.poste?.titre_poste?.includes("Designer") || e.poste?.titre_poste?.includes("Graphiste"));
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "animate-fade-in" }, _attrs))}><div class="page-header"><div><h1 class="page-title">Tâches Designers</h1><p class="page-subtitle" style="${ssrRenderStyle({ "margin-bottom": "0" })}">Suivi des créations graphiques (affiches, caroussels IG).</p></div><button class="btn btn-primary">`);
      ...
      if (filteredTasks.value.length === 0) {
        _push(`<tr><td colspan="8" style="${ssrRenderStyle({ "text-align": "center", "padding": "2rem", "color": "var(--text-secondary)" })}">Aucun livrable trouvé.</td></tr>`);
      } else {
        _push(`<!---->`);
      }
          ...
          if (_push2) {
            ...
            return [
              createVNode("form", {
                ...
                createVNode("div", { class: "form-group" }, [
                  createVNode("label", { class: "form-label" }, "Attribuer à (Designer)"),
...
//# sourceMappingURL=designer-OpBbe5_k.js.map
