declare global {
  ...
  const analyzeMetaPage: typeof import('../../server/utils/geminiMeta').analyzeMetaPage
  ...
  const fetchAdCampaigns: typeof import('../../server/utils/metaApi').fetchAdCampaigns
  const fetchAdInsights: typeof import('../../server/utils/metaApi').fetchAdInsights
  const fetchAllBudgetData: typeof import('../../server/utils/sheetsApi').fetchAllBudgetData
  const fetchCityBudgetData: typeof import('../../server/utils/sheetsApi').fetchCityBudgetData
  const fetchMyPages: typeof import('../../server/utils/metaApi').fetchMyPages
  const fetchPageInfo: typeof import('../../server/utils/metaApi').fetchPageInfo
  const fetchPageInsights: typeof import('../../server/utils/metaApi').fetchPageInsights
  const fetchPagePosts: typeof import('../../server/utils/metaApi').fetchPagePosts
  const fetchWithEvent: typeof import('../../node_modules/h3').fetchWithEvent
  const formatSheetForAI: typeof import('../../server/utils/sheetsApi').formatSheetForAI
  const fromNodeMiddleware: typeof import('../../node_modules/h3').fromNodeMiddleware
  const fromPlainHandler: typeof import('../../node_modules/h3').fromPlainHandler
  const fromWebHandler: typeof import('../../node_modules/h3').fromWebHandler
  const generateDemoAnalysis: typeof import('../../server/utils/geminiMeta').generateDemoAnalysis
  ...
  const normalizePost: typeof import('../../server/utils/metaApi').normalizePost
...
declare global {
  ...
  // @ts-ignore
  export type { PostAnalysis, BudgetReallocation, AudienceAlert, ContentIntel, WeeklyAction, MetaAnalysisResult } from '../../server/utils/geminiMeta'
  import('../../server/utils/geminiMeta')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'D:/planning/systeme_centralise/frontend_nuxt/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'D:/planning/systeme_centralise/frontend_nuxt/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { hashPassword, verifyPassword, signToken, verifyToken } from 'D:/planning/systeme_centralise/frontend_nuxt/server/utils/auth';
export { analyzeMetaPage, generateDemoAnalysis } from 'D:/planning/systeme_centralise/frontend_nuxt/server/utils/geminiMeta';
export { fetchPagePosts, fetchPageInsights, fetchPageInfo, fetchAdCampaigns, fetchAdInsights, fetchMyPages, normalizePost } from 'D:/planning/systeme_centralise/frontend_nuxt/server/utils/metaApi';
export { prisma } from 'D:/planning/systeme_centralise/frontend_nuxt/server/utils/prisma';
export { fetchCityBudgetData, fetchAllBudgetData, formatSheetForAI } from 'D:/planning/systeme_centralise/frontend_nuxt/server/utils/sheetsApi';